...
Что - бы воспользоваться генератором в классе Table запустите метод Main.
В консоле введите необходимое количество пользователей, количество пользователей должно быть указано в целочисленном формате от 1 до 30.
